<template>
    <div class="input-wrap"
        ...
        <i class="input-bar"></i>
        <input :readonly="selectArr" class="input-con" v-if="type == 'text'" type="text" @input="change" v-model="input_value" @focus="focusFun" @blur="blurFun">
